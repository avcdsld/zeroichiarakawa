export default function Page() {
  return (
    ...
    <div className="prose prose-sm prose-invert max-w-none text-gray-200">
      ...
      <p>
        2023　“<a href="/code-poetry-collection">コード詩集</a>” (A collection
        of poems self-published at 技術書典 15)
        <br />
        2023　“
        <a href="/crypto-modern-poetry">
      ...
      <h3 className="text-base font-normal">著作</h3>
      <p>
        2023　『<a href="/code-poetry-collection">コード詩集</a>』（技術書典 15
        にて自主出版した詩集）
        <br />
        2023　『
        <a href="/crypto-modern-poetry">
